...
const CardsCharacters = async () => {
  ...
  return (
    <div className="flex flex-wrap items-center mt-16 bg-gray-300">
      {characters.map((e) => (
        <div key={e.id} className="flex items-center justify-center w-72 m-12 p-2 border border-black bg-gradient-to-br from-[#E18302] to-white rounded-lg shadow-md">
          ...
          <div className="flex-row items-center justify-center ml-2">
            ...
            <p className="text-lg font-medium font-sans text-[#ff2323]">{e.name}</p>
            <p className="font-sans font-bold text-xl">Ki: </p>
            <p className="text-lg font-medium font-sans text-[#ff2323]">{e.ki}</p>
            <p className="font-sans font-bold text-xl">Raza: </p>
            <p className="text-lg font-medium font-sans text-[#ff2323]">{e.race}</p>
            <p className="font-sans font-bold text-xl">Afiliacion: </p>
            <p className="text-lg font-medium font-sans text-[#ff2323]">{e.affiliation}</p>
          </div>
        </div>
      ))}
    </div>
